...
*Analyzing Sociopatterns data sets to study patterns of human contact durations.
*Creating and analyzing networks derived from contact data to obtain key figures about network structure.
*Studying homophily in contact data, i.e., the tendency of individuals to interact with others sharing related socio-demographic attributes.
...
face2face can import:
*User-provided tij- and metadata data sets.
*Predefined data sets included in the installed library.

Data can be imported in various formats using the import module.
The tutorial ["import_data_set"](https://github.com/gesiscss/face2face/blob/master/tutorial/import_data_set.ipynb) describes all ways to import predefined or custom datasets.
...
The toolbox produces:

*Probability distributions of contact durations.
*Network measures, including average degree.
*Homophily measures.
*Visualizations of all above analyses.
...
Any hardware that can run Python is able to run this method.
...
Tutorials are available in the repository. For an overview, see the Tutorial README:  
[https://github.com/gesiscss/face2face/blob/master/tutorial/README.md](https://github.com/gesiscss/face2face/blob/master/tutorial/README.md)

Available tutorials:

1. [Exploring the data](https://github.com/gesiscss/face2face/blob/master/tutorial/01_tutorial_exploring_the_data.ipynb)  
2. [First toolbox functions explained (distribution methods)](https://github.com/gesiscss/face2face/blob/master/tutorial/02_tutorial_first_functions.ipynb)  
3. [First toolbox functions explained (average degree methods)](https://github.com/gesiscss/face2face/blob/master/tutorial/03_tutorial_first_functions.ipynb)  
4. [How to import data](https://github.com/gesiscss/face2face/blob/master/tutorial/import_data_set.ipynb)  
5. [Measure the degrees](https://github.com/gesiscss/face2face/blob/master/tutorial/avg_degree.ipynb)  
6. [Dynamic network analysis](https://github.com/gesiscss/face2face/blob/master/tutorial/dynamic_network_analyses.ipynb)  
7. [Measure the homophily](https://github.com/gesiscss/face2face/blob/master/tutorial/homophily.ipynb)  
8. [Calculate different kinds of contact duration](https://github.com/gesiscss/face2face/blob/master/tutorial/probability_distribution_contact_duration.ipynb)  
9. [Instruction on how to use powerlaw function](https://github.com/gesiscss/face2face/blob/master/tutorial/Statistical_characterization.ipynb)  
10. [How to use powerlaw and face2face for statistical characterization](https://github.com/gesiscss/face2face/blob/master/tutorial/How_to_use_statistical_characterization.ipynb) 
...
See the [official repository](https://github.com/gesiscss/face2face) for further information about technical details.
...
The toolbox is currently in alpha version. Users are responsible for ensuring the legality and ethicality of their data use.
...
In case of questions, contact [Andreas Kruff](mailto:andreas.kruff@th-koeln.de).
Issue Tracker [https://github.com/gesiscss/face2face/issues](https://github.com/gesiscss/face2face/issues).
